...
wget "https://storage.googleapis.com/public-datasets-lila/caltechcameratraps/eccv_18_all_images_sm.tar.gz" --directory-prefix=$destFolder/
#azcopy copy https://lilablobssc.blob.core.windows.net/caltechcameratraps/eccv_18_all_images_sm.tar.gz $destFolder/.

echo "Downloading metadata..."
wget "https://storage.googleapis.com/public-datasets-lila/caltechcameratraps/eccv_18_annotations.tar.gz" --directory-prefix=$destFolder/
